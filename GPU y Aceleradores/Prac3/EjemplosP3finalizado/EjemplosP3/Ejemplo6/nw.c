...
void runTest( int argc, char** argv) 
{
	...
	/********************/
	t0 = gettime();
	/* Compute top-left matrix */ //Hacer pragma a esta matriz uno de los dos bucles lleva pragma

#pragma acc data copy(nw_matrix[0:max_rows*max_cols]) copyin(input1[0:max_cols-1],input2[0:max_rows-1],blosum62[0:24][0:24])
{
