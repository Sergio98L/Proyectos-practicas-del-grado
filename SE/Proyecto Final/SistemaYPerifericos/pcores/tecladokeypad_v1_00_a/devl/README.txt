...
Peripheral Summary:
  ...
  logical library name                       : tecladokeypad_v1_00_a
  top name                                   : tecladokeypad
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- ISE project file(s)
  ...
  devl/projnav/tecladokeypad.ise
...
- XST synthesis file(s)
  ...
  devl/synthesis/tecladokeypad_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/tecladokeypad_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/tecladokeypad_v2_1_0.tcl
