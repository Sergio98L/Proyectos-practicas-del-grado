/*****************************************************************************
* Filename:          C:\Users\VUser\Desktop\Practica5SE/drivers/ledsrgb_v1_00_a/src/ledsrgb_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the ledsrgb driver
...
XStatus LEDSRGB_SelfTest(void * baseaddr_p)
{
  ...
  LEDSRGB_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = LEDSRGB_mReadSlaveReg0(baseaddr, 0);
  ...
  LEDSRGB_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = LEDSRGB_mReadSlaveReg1(baseaddr, 0);
  ...
  LEDSRGB_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = LEDSRGB_mReadSlaveReg2(baseaddr, 0);
