/*****************************************************************************
* Filename:          C:\Users\VUser\Desktop\Practica5SE/drivers/motor_hw_v1_00_a/src/motor_hw_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the motor_hw driver
...
XStatus MOTOR_HW_SelfTest(void * baseaddr_p)
{
  ...
  MOTOR_HW_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = MOTOR_HW_mReadSlaveReg0(baseaddr, 0);
  ...
  MOTOR_HW_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = MOTOR_HW_mReadSlaveReg1(baseaddr, 0);
