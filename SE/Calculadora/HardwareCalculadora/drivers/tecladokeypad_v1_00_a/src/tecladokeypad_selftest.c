/*****************************************************************************
* Filename:          C:\Users\VUser\Desktop\Practica5SE/drivers/tecladokeypad_v1_00_a/src/tecladokeypad_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the tecladokeypad driver
...
XStatus TECLADOKEYPAD_SelfTest(void * baseaddr_p)
{
  ...
  TECLADOKEYPAD_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = TECLADOKEYPAD_mReadSlaveReg0(baseaddr, 0);
  ...
  TECLADOKEYPAD_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = TECLADOKEYPAD_mReadSlaveReg1(baseaddr, 0);
  ...
  TECLADOKEYPAD_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = TECLADOKEYPAD_mReadSlaveReg2(baseaddr, 0);
  ...
  TECLADOKEYPAD_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = TECLADOKEYPAD_mReadSlaveReg3(baseaddr, 0);
